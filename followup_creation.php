...
if (isset ($_POST['action']))
{
	switch ($_POST['action'])
	{
		case 'create_groups' :
			...
			header('Location: followup.php?action=show_msg&msg='.$msg);
			break;
...
elseif (isset ($_POST['number_of_groups']))
{
	...
	{
		Display :: display_error_message(get_lang('PleaseEnterValidNumber').'<br/><br/><a href="followup_creation.php?'.api_get_cidreq().'">&laquo; '.get_lang('Back').'</a>',false);
	}
	else
	{
